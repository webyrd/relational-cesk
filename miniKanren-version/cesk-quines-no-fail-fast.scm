...
;;; Version of the cesk-quines.scm code that doesn't use the fail-fast
;;; optimization for ensuring that the rand argument in an application
;;; evaluates to a closure.  This code is only for benchmarking, and
;;; was created only because the order of answers changes with the
;;; optimization.
...
;;;
;;; comment out the optimization for benchmarking:
;;;
;         (fresh (x body env^)
;           (== `(closure ,x ,body ,env^) p))
  ...
  '((('_.0 (_.1 _.2) _.3 (empty-k) _.0)
    ...
    (('_.0
      ...
      (application-inner-k
       (closure _.7 _.8 ((_.8 . _.9) (_.10 . _.11)))
       (application-inner-k
        (closure _.12 '_.0 (_.13 _.14))
        (empty-k)
        _.0)
       _.0)
      _.0)
     (=/= ((_.10 _.3)) ((_.12 quote)) ((_.7 _.8)))
     (num _.10 _.3)
     (sym _.12 _.7 _.8)
     (absento (_.10 _.4) (closure _.0) '_.1 '_.13))
    ((_.0 ((_.0 . _.1) (_.2 . _.3))
    ...
    (('_.0
      (_.1 _.2)
      ((_.3 _.4 . _.5) (_.6 _.0 . _.7))
      (application-inner-k
       (closure _.8 _.9 ((_.9 . _.10) (_.4 . _.11)))
       (empty-k)
       _.0)
      _.0)
     (=/= ((_.3 _.4)) ((_.8 _.9)))
    ...
    ((_.0 ((_.0 . _.1) (_.2 . _.3))
          ...
          (application-inner-k
           (closure _.9 '_.10 (_.11 _.12))
           (application-inner-k
            (closure _.13 '_.7 (_.14 _.15))
            (empty-k)
            _.7)
           _.10)
          _.7)
     (=/= ((_.13 quote)) ((_.2 _.4)) ((_.9 quote)))
     (num _.2 _.4)
     (sym _.0 _.13 _.9)
     (absento (closure _.10) (closure _.7) '_.11 '_.14))))
...
(test "cesk-quinec-bkwards-c"
  (run 10 (q)
    (evalo q quinec))
  '('((lambda (x) (list x (list 'quote x))) '(lambda (x) (list x (list 'quote x)))) (list '(lambda (x) (list x (list 'quote x))) ''(lambda (x) (list x (list 'quote x)))) (((lambda (_.0) '((lambda (x) (list x (list 'quote x))) '(lambda (x) (list x (list 'quote x))))) '_.1) (=/= ((_.0 quote))) (sym _.0) (absento (closure _.1))) (((lambda (_.0) _.0) '((lambda (x) (list x (list 'quote x))) '(lambda (x) (list x (list 'quote x))))) (sym _.0)) (list '(lambda (x) (list x (list 'quote x))) (list 'quote '(lambda (x) (list x (list 'quote x))))) (((lambda (_.0) '((lambda (x) (list x (list 'quote x))) '(lambda (x) (list x (list 'quote x))))) (lambda (_.1) _.2)) (=/= ((_.0 quote))) (sym _.0)) (list (list 'lambda '(x) '(list x (list 'quote x))) ''(lambda (x) (list x (list 'quote x)))) (((lambda (_.0) '((lambda (x) (list x (list 'quote x))) '(lambda (x) (list x (list 'quote x))))) (list)) (=/= ((_.0 quote))) (sym _.0)) ((list '(lambda (x) (list x (list 'quote x))) ((lambda (_.0) ''(lambda (x) (list x (list 'quote x)))) '_.1)) (=/= ((_.0 quote))) (sym _.0) (absento (closure _.1))) (((lambda (_.0) (list '(lambda (x) (list x (list 'quote x))) ''(lambda (x) (list x (list 'quote x))))) '_.1) (=/= ((_.0 list)) ((_.0 quote))) (sym _.0) (absento (closure _.1)))))
...
(test "cesk-fresh-bkwards"
  (run 10 (q)
    (fresh (expr v)
      (evalo expr v)
      (== `(,expr ,v) q)))
  '((('_.0 _.0) (absento (closure _.0))) ((lambda (_.0) _.1) (closure _.0 _.1 (() ()))) ((list) ())
...
(test "cesk-quinec-for-real-3"
  (run 3 (q)
    (evalo q q))
  '((((lambda (_.0) (list _.0 (list 'quote _.0))) '(lambda (_.0) (list _.0 (list 'quote _.0)))) (=/= ((_.0 closure)) ((_.0 list)) ((_.0 quote))) (sym _.0)) (((lambda (_.0) (list (list 'lambda '(_.0) _.0) (list 'quote _.0))) '(list (list 'lambda '(_.0) _.0) (list 'quote _.0))) (=/= ((_.0 closure)) ((_.0 list)) ((_.0 quote))) (sym _.0)) (((lambda (_.0) (list _.0 (list ((lambda (_.1) 'quote) '_.2) _.0))) '(lambda (_.0) (list _.0 (list ((lambda (_.1) 'quote) '_.2) _.0)))) (=/= ((_.0 closure)) ((_.0 lambda)) ((_.0 list)) ((_.0 quote)) ((_.1 closure)) ((_.1 quote))) (sym _.0 _.1) (absento (closure _.2)))))
