    ...
    (fresh (expr env store k val)
      ...
      (condu
        ...
        [(project (expr env store k val)
           (begin
             (errorf 'combined-test-1 "eval-expo can't handle state generated by eval-expo-simple: ~s ~s ~s ~s\n" env store k val)
             (== #f #f)))]))))
  50)
   ...
   (run 50 (q)
    (fresh (expr env store k val)
      ...
      (condu
        ...
        [(project (expr env store k val)
           (begin
             (errorf 'combined-test-2 "eval-expo-simple can't handle state generated by eval-expo: ~s ~s ~s ~s\n" env store k val)
             (== #f #f)))]))))
  50)
